...
@Table(name = "tb_game")
public class Game {
    @Id //define o atribuo como chave primária
    @GeneratedValue(strategy = GenerationType.IDENTITY) //define que o Id será gerado automaticamente. Com a estratégia para gerar o auto incremento para gerar automaticamente o valor do campo.
    private Long id;
